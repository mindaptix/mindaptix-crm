...
const DASHBOARD_PAGE_KEYS: DashboardPageKey[] = ["employees", "projects", "attendance", "leaves", "tasks", "dsr", "reports", "payroll", "expenses", "payments", "assets", "regularize", "documents", "alldocs", "announcements", "holidays", "settings"];
